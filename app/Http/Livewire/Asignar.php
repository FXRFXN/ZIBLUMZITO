...
{
    use WithPagination;
    public $role, $componetName, $permisosSelected=[], $old_permissions = [];
    ...
    
    {
        ...
        if($this->role != 'Elegir')
        {
            $list = Permission::join('role_has_permission as rp', 'rp.permission_id','permissions.id')
    ...
    public function syncPermiso($state, $permisoName)
    {
        if($this->role !='Elegir')
        {
            ...
            $this->emit('permi', "Porfavor elige un rol");
