...
<tr>
         ...
         <th with="13%"class="table-th text-center text-white">CANTIDAD</th>
         <th class="table-th text-center text-white">IMPORTE</th>
      <!--    <th class="table-th text-center text-">ACTIONS</th >-->
</tr>
</thead>
...
<tr>
    <td class="text-center table-th" >
        ...
        <span>
            <img src="{{asset('storage/products/' . $item-> attributes[0]) }}" alt =
            "imágen de producto" height="90" width="90" class="rounded" >
        </span>
        @endif
    </td>
    <td> <h6 h6> {{$item->name }} </h6> </td>
