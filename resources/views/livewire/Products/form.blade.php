...
<div class="form-group">
<label class="text-black">Código de barras</label>
...
<div class="col-sm-12 col-md-4">
<div class="form-group">
<label class="text-black">Costo de elaboracion</label>
...
<div class="col-sm-12 col-md-4">
<div class="form-group ">
<label class="text-black" >Precio de venta</label>
...
<div class="col-sm-12 col-md-4">
<div class="form-group">
<label class="text-black">Inventario restante</label>
