                    ...
                    <div class="col-sm-12 col-md-3"> 
                        ...
                        <div class="col-sm-12 col-md-9">
                            ...
                            <div class="table-responsive">
                                ...
                                <tr>
                                <th class="table-th text-black">FOLIO</th>
                                <th class="table-th text-black">TOTAL</th>
                                <th class="table-th text-black">ITEMS</th>
                                <th class="table-th text-black">ESTADO</th>
                                <th class="table-th text-black">USUARIO</th>
                                <th class="table-th text-black">FECHA</th>
                                <th class="table-th text-black" width="50px"></th>
                            </tr>
                            </thead>
                            <tbody>
                                @if(count($data) <1 )
